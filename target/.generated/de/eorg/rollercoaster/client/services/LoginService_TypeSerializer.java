...
public class LoginService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.google.appengine.api.datastore.EntityNotFoundException/1846697797"] = [
        @com.google.appengine.api.datastore.EntityNotFoundException_CustomFieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.google.appengine.api.datastore.EntityNotFoundException_CustomFieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/google/appengine/api/datastore/EntityNotFoundException;),
      ];
    ...
    result["de.eorg.rollercoaster.client.exceptions.OutOfQuotaException/3694992072"] = [
        @de.eorg.rollercoaster.client.exceptions.OutOfQuotaException_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @de.eorg.rollercoaster.client.exceptions.OutOfQuotaException_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lde/eorg/rollercoaster/client/exceptions/OutOfQuotaException;),
      ];
    
    result["de.eorg.rollercoaster.shared.model.LoginInfo/113414966"] = [
        @de.eorg.rollercoaster.shared.model.LoginInfo_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @de.eorg.rollercoaster.shared.model.LoginInfo_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lde/eorg/rollercoaster/shared/model/LoginInfo;),
      ];
    
    result["de.eorg.rollercoaster.shared.model.Member/2848774648"] = [
        @de.eorg.rollercoaster.shared.model.Member_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @de.eorg.rollercoaster.shared.model.Member_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lde/eorg/rollercoaster/shared/model/Member;),
        @de.eorg.rollercoaster.shared.model.Member_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lde/eorg/rollercoaster/shared/model/Member;)
      ];
    
    result["de.eorg.rollercoaster.shared.model.UserRole/4151405745"] = [
        @de.eorg.rollercoaster.shared.model.UserRole_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @de.eorg.rollercoaster.shared.model.UserRole_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lde/eorg/rollercoaster/shared/model/UserRole;),
        @de.eorg.rollercoaster.shared.model.UserRole_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lde/eorg/rollercoaster/shared/model/UserRole;)
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@de.eorg.rollercoaster.shared.model.Member::class)] = "de.eorg.rollercoaster.shared.model.Member/2848774648";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@de.eorg.rollercoaster.shared.model.UserRole::class)] = "de.eorg.rollercoaster.shared.model.UserRole/4151405745";
