package de.eorg.rollercoaster.shared.cloudmapping.model;
...
import de.eorg.rollercoaster.shared.cloudmapping.model.mapping.IAttributedItem;
...
public class AMI extends Appliance {
	...
	public AMI(String name, List<Attribute<?>> attributes) {
