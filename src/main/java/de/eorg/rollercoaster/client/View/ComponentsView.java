package de.eorg.rollercoaster.client.View;
...
public class ComponentsView extends AbstractView {
	...
	public ComponentsView() {
		final RollerCoasterServiceAsync cumulusGeniusService = GWT.create(RollerCoasterService.class);
		...
		nextButton.addClickHandler(new ViewHandler(RollerCoaster.requirementsView));
