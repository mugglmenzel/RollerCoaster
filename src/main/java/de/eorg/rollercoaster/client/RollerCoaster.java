...
import de.eorg.rollercoaster.client.View.ComponentsView;
import de.eorg.rollercoaster.client.View.CriteriaView;
import de.eorg.rollercoaster.client.View.PreferencesView;
import de.eorg.rollercoaster.client.View.RecommendationView;
import de.eorg.rollercoaster.client.View.RequirementsView;
import de.eorg.rollercoaster.client.View.WelcomeView;
import de.eorg.rollercoaster.client.View.Handlers.ViewHandler;
...
public class RollerCoaster implements EntryPoint {
	...
	private void createMasterLayout() {
		...
		RootPanel.get("rollercoaster").add(vPan);
