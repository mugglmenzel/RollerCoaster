package de.eorg.rollercoaster.client.views;
...
public class ComponentsView extends AbstractView {
	...
	public ComponentsView() {
		final RollerCoasterServiceAsync cumulusGeniusService = GWT
		...
		saveButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				 ...
				 * cumulusGeniusService
				 * .createComponent(componentsField[i].getDisplayField(),
				 * componentsField
				 * [i+1].getDisplayField(),componentsField[i+2].getDisplayField
				 * (), new AsyncCallback<Void>(){
				 * 
				 * @Override public void onSuccess(Void test) {
				 * 
				 *           //SC.say("Saved."); }
		...
		nextButton.addClickHandler(new ViewHandler(
				RollerCoaster.requirementsView));
		backButton
				.addClickHandler(new ViewHandler(RollerCoaster.componentsView));
